...
<div class="card-body">
  <h4 class="card-description">{{ __('All Product Offer Details') }}</h4>
<div class="container">
...
{{ \Carbon\Carbon::parse($off->validity_To)->format('h:m A')}}
		...
		<td> 
         ...
         <a href="{{route('get:ProductOfferController:edit',['id'=>$off->id])}}"><span class="fa fa-pencil-square-o"></span></a>
...
<script>
  ...
  var id=$(this).data('id');
  $.post("/product_offer/show/delete",{
    'delete':id,
