...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-description">{{ __('Edit Prodect Offer Details') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('post:ProductOfferController:update')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select  class="chosen-select form-control" name="choose_product_name">
                                	<option value="{{$offer->product_id}}">{{$offer->product->product_name}}</option>
