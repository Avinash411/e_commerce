...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h4 class="card-description">{{ __('Enter Category Offer Details') }}</h4>

                <div class="card-body">
                    <form method="POST" action="{{route('post:CategoryOfferController:store')}}">
                        @csrf
     ...
     <button type="submit" name="save_and_more" class="btn btn-primary mdi mdi-file-document" value="add">
      {{ __('Add more') }}</button>
       ...
       <a href="{{route('get:CategoryOfferController:show')}}"><button type="button"  name="cancel" class="btn btn-secondary mdi mdi-refresh" value="can">
    {{ __('Cancel') }}</button></a>
